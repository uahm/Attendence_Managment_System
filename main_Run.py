    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='Sqlroot#1', db='manually_fill_attendance')
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/Umair Ahmed/Desktop/Attendance Management System using Face Recognition/Attendance/Manually Attendance/'+DB_table_name+'.csv'
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(
                        host='localhost', user='root', password='Sqlroot#1', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/Umair Ahmed/Desktop/Attendance Management System using Face Recognition/Attendance/' + fileName
    ...
    def log_in():
        ...
        if username == 'Umair':
            if password == 'Umair123':
                ...
                cs = 'C:/Users/Umair Ahmed/Desktop/Attendance Management System using Face Recognition/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
